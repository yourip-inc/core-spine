...
describe("CONTRIBUTOR_ROLES", () => {
  it("test_claim_10_videographer_role_named_is_canonical", () => {
    expect(CONTRIBUTOR_ROLES).toContain("VIDEOGRAPHER");
  });

  it("test_claim_10_filmer_is_not_in_canonical_list", () => {
  ...
  it("test_claim_10_all_contributor_roles_are_uppercase", () => {
...
describe("DEPRECATED_ROLE_ALIASES", () => {
  it("test_claim_10_filmer_aliases_to_videographer", () => {
    expect(DEPRECATED_ROLE_ALIASES.FILMER).toBe("VIDEOGRAPHER");
  });
});

describe("isContributorRole", () => {
  it("test_claim_10_canonical_role_is_recognized", () => {
  ...
  it("test_claim_10_filmer_alias_is_not_a_canonical_role", () => {
  ...
  it("test_claim_10_lowercase_role_is_not_recognized", () => {
    // Case-sensitive by design.
    expect(isContributorRole("videographer")).toBe(false);
    expect(isContributorRole("Videographer")).toBe(false);
  });

  it("test_claim_10_nonstring_input_is_not_a_role", () => {
...
describe("normalizeContributorRole", () => {
  describe("canonical inputs", () => {
    it("test_claim_10_normalize_videographer_returns_canonical_unchanged", () => {
    ...
    it("test_claim_10_normalize_editor_returns_canonical_unchanged", () => {
  ...
  describe("deprecated alias", () => {
    it("test_claim_10_normalize_filmer_alias_returns_videographer_with_deprecation_flag", () => {
  ...
  describe("invalid inputs", () => {
    it("test_claim_10_normalize_unknown_role_throws", () => {
      expect(() => normalizeContributorRole("DIRECTOR")).toThrow(/unknown contributor role/);
    });

    it("test_claim_10_normalize_empty_string_throws", () => {
      expect(() => normalizeContributorRole("")).toThrow(/unknown contributor role/);
    });

    it("test_claim_10_normalize_lowercase_canonical_throws", () => {
    ...
    it("test_claim_10_normalize_lowercase_alias_throws", () => {
