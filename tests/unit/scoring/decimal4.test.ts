 ...
 * Decimal4 unit tests.
 *
 * Patent claims: CS-3 (effective vote mass arithmetic), CS-14 (integer-only canonical JSON).
 * Story: T1-S1-B-02.
 *
...
describe("Decimal4", () => {
  describe("parsing and formatting", () => {
    it("test_claim_CS_14_decimal4_parses_simple_values", () => {
    ...
    it("test_claim_CS_14_decimal4_rejects_more_than_four_decimal_places", () => {
      expect(() => Decimal4.parse("1.23456")).toThrow();
    });

    it("test_claim_CS_14_decimal4_rejects_non_numeric_input", () => {
    ...
    it("test_claim_CS_14_decimal4_fromInteger_roundtrips", () => {
  ...
  describe("arithmetic", () => {
    it("test_claim_CS_3_decimal4_addition_is_exact", () => {
      const a = Decimal4.parse("1.5");
      const b = Decimal4.parse("2.5");
      expect(a.add(b).toString()).toBe("4.0000");
    });

    it("test_claim_CS_3_decimal4_subtraction_is_exact", () => {
      expect(Decimal4.parse("3.0").sub(Decimal4.parse("1.25")).toString()).toBe("1.7500");
    });

    it("test_claim_CS_3_decimal4_multiplication_uses_scale_correction", () => {
      // 2 * 3 = 6
    ...
    it("test_claim_CS_3_decimal4_division_truncates_toward_zero", () => {
    ...
    it("test_claim_CS_3_decimal4_division_by_zero_throws", () => {
      expect(() => Decimal4.parse("1").div(Decimal4.parse("0"))).toThrow(/division by zero/);
    });

    it("test_claim_CS_3_decimal4_mulInteger_is_exact", () => {
  ...
  describe("comparison", () => {
    it("test_claim_CS_3_decimal4_comparisons_match_string_order_for_equal_scale", () => {
  ...
  describe("determinism", () => {
    it("test_claim_CS_3_decimal4_same_inputs_produce_identical_output", () => {
      const run = (): string => {
    ...
    it("test_claim_CS_3_decimal4_toTruncatedInteger_drops_fractional_part", () => {
